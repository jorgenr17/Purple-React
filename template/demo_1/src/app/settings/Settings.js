      ...
      <div className="row">
        ...
        <div className="col-md-6 grid-margin stretch-card">
          <div className="card">
            ...
            <div className="card-body">
              <p className="card-description">
                Add className <code>.form-check-&#123;color&#123;</code> for checkbox and radio controls in theme colors
              </p>
              <form>
                <div className="row">
                  <div className="col-md-6">
        ...
        <div className="col-12 grid-margin stretch-card">
          <div className="card">
            <div className="card-body">
              ...
              <p className="card-description">
                {' '}
                Use the <code>.form-inline</code> className to display a series of labels, form controls, and buttons on
                ...
                <div className="row">
                  ...
                  <div className="col-md-6">
                    <Form.Group className="row">
                      ...
                      <div className="col-sm-9">
                        <DatePicker className="form-control w-100" selected={state.startDate} onChange={handleChange} />
                      </div>
                    </Form.Group>
                  </div>
                </div>
