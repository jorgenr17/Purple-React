      ...
      <div>
        ...
        <div className="page-header">
          <h3 className="page-title">
            ...
            Dashboard / Nombre del curso
          </h3>
          <div className="d-flex">
            <div className="card-body">
              <div className="template-demo">
                <Dropdown className="mr-5">
                  <Dropdown.Toggle variant="btn btn-primary" id="dropdownMenuButton2">
                    Curso
                  </Dropdown.Toggle>
                  <Dropdown.Menu>
        ...
        <div className="row">
          <div className="col-12 grid-margin">
            <div className="card">
              <div className="card-body">
                <h4 className="card-title">Detalles del curso</h4>
                <div className="table-responsive">
                  <table className="table">
                    ...
                    <tbody>
                      <tr>
                        <td>
                          <img src={require('../../assets/images/faces/face1.jpg')} className="mr-2" alt="face" /> David
                          Grey{' '}
                        </td>
                      ...
                      <tr>
                        <td>
                          <img src={require('../../assets/images/faces/face4.jpg')} className="mr-2" alt="face" /> John
                          Doe{' '}
                        </td>
